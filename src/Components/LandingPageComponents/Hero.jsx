...
export default function Hero() {
  ...
  const { getPrice, isLoading: isPricingLoading } = usePricing();
  const { whatsappUrl } = useWhatsAppRouting();
  
  const ctPrice = getPrice("corporate-tax");
    ...
    <section className="land-vm-page">
      <div className="land-vm-shell">
        ...
        <div className="land-vm-topbar">
          ...
          <a className="land-vm-wa-pill" href={whatsappUrl}>
        ...
        <div className="land-vm-layout">
          ...
          <div className="land-vm-leftCard">
            ...
            <a className="land-vm-wa-btn" href={whatsappUrl}>
              <i className="bi bi-whatsapp" /> WhatsApp us
            </a>
          ...
          >
            ...
            <div className="land-pricelist">
              ...
              {isPricingLoading ? (
                ...
                <p>
                    {ctPrice.currency} <span className="land-p1">{ctPrice.originalPrice}</span>{" "}
                    <span className="land-p2">{ctPrice.price}</span>
                </p>
              )}
            </div>
          </div>
